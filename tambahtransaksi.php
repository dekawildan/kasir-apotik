                ...
                <form method="post" action="simpantransaksi.php">
                    <table width="90%" border="0" cellpadding="3" cellspacing="3">
                        ...
                        <tr>
                            ...
                            <td width="65%">: 
                                <input type="date" name="tanggal_transaksi" class="kolom" id="tanggal_transaksi" required>
                            </td>
                        </tr>
                        <tr>
                            <td width="25%"></td>
                        ...
                        <tr>
                            ...
                            <td width="65%">: 
                                <input type="number" name="jumlah_beli" class="kolom" id="jumlah_beli" placeholder="Jumlah Beli..." required>
                            </td>
                        </tr>
                        <tr>
                            <td width="25%"></td>
                        ...
                        <tr>
                            ...
                            <td width="65%">: 
                                <input type="number" name="jumlah_harga" class="kolom" id="jumlah_harga" placeholder="Jumlah Harga..." required>
                            </td>
                        </tr>
                        <tr>
                            <td width="25%"></td>
                        ...
                        <tr>
                            ...
                            <td width="65%">: 
                                <input type="number" name="diskon" class="kolom" id="diskon" placeholder="Diskon..." required>
                            </td>
                        </tr>
                        <tr>
                            <td width="25%"></td>
                        ...
                        <tr>
                            ...
                            <td width="65%">: 
                                <input type="number" name="harga_setelah_diskon" class="kolom" id="harga_setelah_diskon" placeholder="Harga Setelah Diskon..." onclick="hitungharga()" readonly required>
                            </td>
                        </tr>
                        <tr>
                            <td width="25%"></td>
