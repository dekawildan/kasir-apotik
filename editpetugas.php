    ...
    <article id="article">
        <section>
            ...
            <?php
                ...
                $sql=mysqli_query($koneksi, "SELECT * FROM tbl_login WHERE user_id='$user_id'");
                while($rowpetugas=mysqli_fetch_array($sql)) {
            ?>
                <h2 align="center">Edit Petugas <?php echo $rowpetugas['nama_petugas']; ?></h2>
                <form method="post" action="updatepetugas.php">
                    <table width="90%" border="0" cellpadding="3" cellspacing="3">
                        <tr>
                            <td width="25%">Nama Lengkap
                                <input type="hidden" name="user_id" value="<?php echo $rowpetugas['user_id']; ?>">
                            </td>
                            <td width="65%">: <input name="nama_petugas" id="namapetugas" type="text" value="<?php echo $rowpetugas['nama_petugas']; ?>" class="kolom" placeholder="Nama Lengkap..." required></td>
                        </tr>
                        <tr>
                            <td width="25%"></td>
                        ...
                        <tr>
                            ...
                            <td width="65%">: <input name="username" id="user" type="text" value="<?php echo $rowpetugas['username']; ?>" class="kolom" placeholder="Username..." required></td>
                        </tr>
                        <tr>
                            <td width="25%"></td>
